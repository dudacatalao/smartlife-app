...
import img5 from '../images/cinco.jpg';
        ...
        <section className="bg-background text-gray-100">
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-white hidden sm:block">
                        <img role="presentation" className="object-cover w-full rounded h-44 bg-gray-500" src={img5} alt="Imagem 5" />
                        <div className="p-6 space-y-2">
                            <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline text-gray-900">Segurança e Privacidade em Cidades Conectadas</h3>
                            <span className="text-xs text-gray-400">January 25, 2021</span>
                            <p className="text-gray-900">Explore os desafios e soluções relacionados à segurança cibernética, proteção de dados pessoais e privacidade em cidades inteligentes, garantindo que o avanço tecnológico não comprometa a segurança e a liberdade dos cidadãos</p>
                        </div>
                    </a>
                    <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-white hidden sm:block">
                        <img role="presentation" className="object-cover w-full rounded h-44 bg-gray-500" src={img6} alt="Imagem 6" />
                        <div className="p-6 space-y-2">
                            <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline text-gray-900">Comunidades Resilientes</h3>
                            <span className="text-xs text-gray-400">January 26, 2021</span>
                            <p className="text-gray-900">Explore como as cidades estão se adaptando às mudanças climáticas e desafios sociais através da colaboração, inovação e uso inteligente da tecnologia, criando comunidades mais resilientes e preparadas para o futuro</p>
                        </div>
                    </a>
                </div>
            </div>
