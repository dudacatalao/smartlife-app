    ...
    <section className="py-6 bg-background">
        <div className="container p-4 mx-auto space-y-16 sm:p-10">
            <div className="space-y-4">
                <h3 className="text-2xl font-bold leading-none sm:text-5xl">Conheça o nosso time</h3>
                <p className="max-w-2xl dark:text-gray-600 ml-96">Bem-vindo à equipe do Smart Life, cada um contribuindo com suas habilidades e perspectivas únicas para enriquecer nossa comunidade.</p>
            </div>
            <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
                <div className="flex space-x-6">
                    ...
                    <div className="flex flex-col">
                        <h4 className="text-xl font-semibold">Eduarda Catalão</h4>
                        <p className="text-sm dark:text-gray-600">Front-end Developer</p>
                ...
                <div className="flex space-x-6">
                    ...
                    <div className="flex flex-col">
                        <h4 className="text-xl font-semibold">Manuelly Carvalho</h4>
                ...
                <div className="flex space-x-6">
                    ...
                    <div className="flex flex-col">
                        <h4 className="text-xl font-semibold">Betman Octavio</h4>
                        <p className="text-sm dark:text-gray-600">Web developer</p>
                        <div className="flex mt-2 space-x-2">
                            <a rel="noopener noreferrer" href="#" title="Twitter" className="dark:text-gray-600">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" className="w-4 h-4">
                ...
                <div className="flex space-x-6">
                    ...
                    <div className="flex flex-col">
                        <h4 className="text-xl font-semibold">Kamila Carvalho</h4>
                        <p className="text-sm dark:text-gray-600">Web developer</p>
                        <div className="flex mt-2 space-x-2">
                            <a rel="noopener noreferrer" href="#" title="Twitter" className="dark:text-gray-600">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" className="w-4 h-4">
